...
public class AuditService {
    ...
    public void logTokenTheftDetected(UUID tenantId, UUID userId) {
        log("TOKEN_THEFT_DETECTED", false, tenantId, userId, null,
                "Refresh token reuse detected", null, null);
    }

    public void logLogout(AdminUser user) {
        log("LOGOUT", true, user.getTenantId(), user.getId(), user.getEmail(),
                null, null, null);
    }
